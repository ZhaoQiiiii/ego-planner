...
struct LocalTrajData {
  ...
  int traj_id_;
  double duration_;
  double global_time_offset; // This is because when the local traj finished and is going to switch
                             // back to the global traj, the global traj time is no longer matches
                             // the world time.
