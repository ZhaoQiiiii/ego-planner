 ...
 *                          variables.
 */
typedef double (*lbfgs_evaluate_t)(void *instance, const double *x, double *g, const int n);
 ...
 */
typedef double (*lbfgs_stepbound_t)(void *instance, const double *xp, const double *d, const int n);
 ...
 */
typedef int (*lbfgs_progress_t)(void *instance, const double *x, const double *g, const double fx, const double xnorm,
...
inline void veccpy(double *y, const double *x, const int n) { memcpy(y, x, sizeof(double) * n); }
 ...
 */
inline int update_trial_interval(double *x, double *fx, double *dx, double *y, double *fy, double *dy, double *t,
                                 double *ft, double *dt, const double tmin, const double tmax, int *brackt) {
  int bound;
...
inline int line_search_morethuente(int n, double *x, double *f, double *g, double *s, double *stp, const double *xp,
                                   const double *gp, const double *stpmin, const double *stpmax, callback_data_t *cd,
...
static const lbfgs_parameter_t _default_param = {
    8, 1e-5, 0, 1e-5, 0, 40, 1e-20, 1e20, 1e-4, 0.9, 1.0e-16,
};
 ...
 */
inline void lbfgs_load_default_parameters(lbfgs_parameter_t *param) { memcpy(param, &_default_param, sizeof(*param)); }
 ...
 */
inline int lbfgs_optimize(int n, double *x, double *ptr_fx, lbfgs_evaluate_t proc_evaluate,
